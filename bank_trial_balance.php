            ...
            <div class='container'>
                <div class='card'>
                    <div class='card-header'>
                        ...
                        <h5>All Banks Balance Reports </h5>
                    </div>
                        ...
                        <div class="row align-items-start">
                            <div class="col-md-12">
                              ...
                              <table id="# example" class="table-striped table-bordered" style="width:100%">
									...
									<tbody>
										<tr class="bg-warning" style="text-align:right; font-weight:bold;"></tr>
										...
										$ledgerOpeningBalanceQuery = "SELECT c.ac, 
											...
											AS opening_balance FROM customers c 
										...
										$query = "SELECT c.ac, c.first_name, c.last_name, 
												  ...
												  WHERE c.ac_type = '2'  -- Filter based on ac_type
										...
										if ($results) {
											while ($rs = $results->fetch_assoc()) {
												...
												$debit = $netBalance < 0 ? number_format($netBalance, 2) : "0.00";
												$credit = $netBalance < 0 ? "0.00" : number_format($netBalance, 2);

												$totalDebit += $netBalance < 0 ? $netBalance : 0;
												$totalCredit += $netBalance > 0 ? $netBalance : 0;
										?>
										<tr>
											<td><?php echo $id; ?></td>
									...
									<tfoot class="bg-light">
										<tr>
											...
											<td colspan="2">
											<?php echo number_format($totalCredit-$totalDebit, 2); ?>
											</td>
										</tr>
									</tfoot>
								</table>
